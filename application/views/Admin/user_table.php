...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url('public/bower_components/font-awesome-4.7.0/css/font-awesome.min.css')?>">
  <!-- Ionicons -->
...
<script>
    ...
    // }
    //function initOrder() {
    //    var per_page = GetQueryString('per_page');
    //    $.ajax({
    //        type:'post',
    //        url:'<?php //echo base_url()?>//index.php/admin/user/ajax',
    ...
    //                var mobile = userInfo[i].mobile;
    //                var age = userInfo[i].age;
    //                var address= userInfo[i].address;
    //                var create_time = userInfo[i].create_time;
    //
    ...
    //                    '</tr>'
    //            }
    //            if($('.user-table').find('tr').length > 0) {
    //                $('.user-table').empty();
